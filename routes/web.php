...
Route::middleware('auth')->group(function () {
    ...
    Route::patch('/Adicional/{adicional}', [AdicionalController::class, 'update'])->name('adicional.update');
    Route::get('/Ativar-Adicional/{id}', [AdicionalController::class, 'active'])->name('adicional.active');
    Route::delete('/Adicional/{id}', [AdicionalController::class, 'destroy'])->name('adicional.destroy');

    Route::post('/AdicionalProduto', [AdicionaisProdutoController::class, 'ativar'])->name('adicional_produto.ativar');

    Route::get('/SessaoCaixa', [SessaoCaixaController::class, 'index'])->name('sessao_caixa')->middleware('permission:Admin');
    Route::get('/SessaoCaixas-Inativas', [SessaoCaixaController::class, 'inactive'])->name('sessao_caixa.inactive')->middleware('permission:Admin');
    Route::post('/SessaoCaixa', [SessaoCaixaController::class, 'store'])->name('sessao_caixa.store')->middleware('permission:Admin');
    Route::get('/SessaoCaixa/{sessao_caixa}/Finalizar', [SessaoCaixaController::class, 'finalizar'])->name('sessao_caixa.finalizar')->middleware('permission:Admin');
    Route::get('/SessaoCaixa/{sessao_caixa}/Editar', [SessaoCaixaController::class, 'edit'])->name('sessao_caixa.edit')->middleware('permission:Admin');
    Route::patch('/SessaoCaixa/{sessao_caixa}', [SessaoCaixaController::class, 'update'])->name('sessao_caixa.update')->middleware('permission:Admin');
    Route::get('/Ativar-SessaoCaixa/{id}', [SessaoCaixaController::class, 'active'])->name('sessao_caixa.active')->middleware('permission:Admin');
    Route::delete('/SessaoCaixa/{id}', [SessaoCaixaController::class, 'destroy'])->name('sessao_caixa.destroy')->middleware('permission:Admin');
    Route::get('/SessaoCaixa/{sessao_caixa}/Vendas', [SessaoCaixaController::class, 'listarVendasSessaoCaixa'])->name('sessao_caixa.vendas')->middleware('permission:Admin');
    ...
    Route::post('/Cancelar-Pedido/{id}', [PedidoController::class, 'CancelarPedido'])->name('pedido.cancelar');
    Route::post('/Restaurar-Pedido/{id}', [PedidoController::class, 'RestaurarPedido'])->name('pedido.restaurar');
    ...
    Route::post('/Venda/{venda}/cancelar', [VendaController::class, 'cancelarVendaWeb'])->name('venda.cancelar_web');
