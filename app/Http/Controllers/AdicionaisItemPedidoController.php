        ...
        if ($adicionalItemPedido) {
            if ($quantidade == 0) {
                ...
                if ($itemPedido->item_pedido_quantidade == 0.5) {
                    ...
                    $itemPedido->update([
                        ...
                        'item_pedido_valor_unitario' => $itemPedido->item_pedido_valor - $adicionalItemPedido->aip_valor_total,
            ...
            if ($itemPedido->item_pedido_quantidade == 0.5) {
                ...
                $itemPedido->update([
                    ...
                    'item_pedido_valor_unitario' => ($itemPedido->produto->produto_preco_venda * $itemPedido->item_pedido_quantidade) + $valorTotalAdicionais,
