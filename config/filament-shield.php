...
return [
    ...
    */
    ...
    // define_via_gate=true registra um Gate::before global: qualquer usuário com a
    // role Admin passa em QUALQUER Gate::check/can(), no Filament e fora dele — cobre
    // de graça o bypass que as Policies da Fase 2 precisariam registrar manualmente,
    // e evita depender de todas as 280 permissions de CRUD existirem em todo ambiente
    // (ex: banco de teste) só para o Admin conseguir operar o painel.
    'super_admin' => [
        'enabled' => true,
        'name' => 'Admin',
    ...
    */
    ...
    // Desabilitado de propósito: o trait HasPanelShield atribuiria essa role a
    // TODO usuário criado (inclusive Cliente do cadastro público no cardápio),
    // liberando acesso ao /admin por padrão. canAccessPanel() é implementado
    // manualmente em App\Models\User com a lista explícita de roles operacionais.
    'panel_user' => [
        'enabled' => false,
        'name' => 'panel_user',
    ],
    ...
    */
    ...
    'policies' => [
        ...
        // false: 'resources.manage' SUBSTITUI a lista padrão de ações pro resource
        // listado (ex.: RoleResource fica só com as 5 ações do array, não com as
        // 12 padrão + as 5). Com true, o Shield faz array_merge(padrão, custom) e
        // a restrição nunca reduz nada — só soma (bug de config encontrado, único
        // resource com override hoje é RoleResource, sem efeito nos outros 20).
        'merge' => false,
        'generate' => true,
        'methods' => [
    ...
    */
    ...
    'localization' => [
        'enabled' => true,
        // Arquivo próprio do app (lang/pt_BR/shield-labels.php), não o do pacote —
        // o pt_BR nativo do Shield vem com esse array comentado/vazio.
        'key' => 'shield-labels',
    ],
    ...
    */
    ...
    'widgets' => [
        ...
        'exclude' => [
            ...
            // Exclusivos da página inicial (Dashboard, também excluída acima) —
            // ficam abertos a qualquer usuário com acesso ao painel, mesma lógica.
