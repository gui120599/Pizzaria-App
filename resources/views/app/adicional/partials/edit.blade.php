<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            {{ __('Atualizar Adicional') }}
        </h2>

        <p class="mt-1 text-sm text-gray-600">
            {{ __('Insira os dados para atualizar o adicional.') }}
        </p>
    </header>

    <form action="{{ route('adicional.update', ['adicional' => $adicional]) }}" method="post" class="mt-6 space-y-6" enctype="multipart/form-data">
        @csrf
        @method('patch')
            ...
            <div class="col-span-1 md:col-span-3 space-y-3">
                <div>
                    ...
                    <x-text-input id="adicional_nome" name="adicional_nome" type="text" class="mt-1 w-full"
                        value="{{ $adicional->adicional_nome }}" autocomplete="off" autofocus />
                ...
                <div>
                    ...
                    <x-money-input id="adicional_valor" name="adicional_valor" type="text" class="mt-1 w-full money"
                        value="{{ $adicional->adicional_valor }}" autocomplete="off" autofocus />
