<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight flex items-center space-x-2">
            ...
            <a href="{{route('adicional')}}">{{ __('Adicionais') }}</a>
        </h2>
    </x-slot>
                                        ...
                                        <tr class="border-top border-gray-300">
                                            ...
                                            <td>
                                                <div class="flex items-center justify-center space-x-4">
                                                    <x-primary-button
                                                        onclick="window.location.href = '{{ route('adicional.active', ['id' => $adicional->id]) }}'">Ativar</x-primary-button>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
