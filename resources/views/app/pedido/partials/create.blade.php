                    ...
                    <div id="lista_clientes"
                        ...
                        @foreach ($clientes as $cliente)
                            <div id="linha_cliente"
                                ...
                                {{ $cliente->cliente_nome }} - {{ $cliente->cliente_celular }}
                            </div>
                        @endforeach
                    </div>
    ...
    <script type="module">
        $(document).ready(function() {
            ...
            $('#buscar').on('input', function() {
                ...
                if (descricao === "") {
                    // Se o campo de busca estiver vazio, exibe todos os produtos e categorias
                    $('.produto').show();
                    $('.cate').show();
                } else {
                    // Itera sobre cada produto e exibe ou oculta com base na busca
                    ...
                    // Itera sobre cada categoria para verificar se tem produtos visíveis
                    $('.cate').each(function() {
                        const produtosVisiveis = $(this).find('.produto:visible')
                            .length; // Conta quantos produtos estão visíveis na categoria

                        if (produtosVisiveis > 0) {
                            $(this)
                                .show(); // Se a categoria tem produtos visíveis, exiba a categoria
                        } else {
                            $(this).hide(); // Se não, oculte a categoria
                        }
                    });
                }
            });
